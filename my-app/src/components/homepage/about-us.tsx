...
export function AboutUsCard({ icon, title, content }: { icon: string, title: string, content: any }) {
  return (
    <div className="w-[400px] bg-transparent m-0 p-0 flex flex-col items-center justify-center text-center">
      <div className="bg-transparent p-4">
        <img src={icon} alt={`${title} icon`} className="w-[100px] h-[100px] md:mb-4 object-cover"  style={{ display: 'block', margin: '0 auto' }} />
